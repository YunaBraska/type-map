...
public class TypeMapTest {
    ...
    void testDefaultMethods(final String mapName, final TypeMapI<?> typeMap) throws Exception {
        ...
        assertThat(typeMap.putReturn(testKey, "testString").asStringOpt(testKey)).contains("testString");
        ...
        assertThat(typeMap.putReturn(testKey, "123456789").asLongOpt(testKey)).contains(123456789L);
        ...
        assertThat(typeMap.putReturn(testKey, "123456789").asNumberOpt(testKey)).contains(123456789d);
        ...
        assertThat(typeMap.putReturn(testKey, "42").asIntOpt(testKey)).contains(42);
        ...
        assertThat(typeMap.putReturn(testKey, "42.42").asDoubleOpt(testKey)).contains(42.42);
        ...
        assertThat(typeMap.putReturn(testKey, "42.42").asFloatOpt(testKey)).contains(42.42f);
        ...
        assertThat(typeMap.putReturn(testKey, "32000").asShortOpt(testKey)).contains((short) 32000);
        ...
        assertThat(typeMap.putReturn(testKey, "127").asByteOpt(testKey)).contains((byte) 127);
        ...
        assertThat(typeMap.putReturn(testKey, "12345678901234567890").asBigIntegerOpt(testKey)).contains(new BigInteger("12345678901234567890"));
        assertThat(typeMap.putReturn(testKey, "12345.67890").asBigDecimal(testKey)).isEqualTo(new BigDecimal("12345.67890"));
        assertThat(typeMap.putReturn(testKey, "12345.67890").asBigDecimalOpt(testKey)).contains(new BigDecimal("12345.67890"));
        assertThat(typeMap.putReturn(testKey, "42").asAtomicInteger(testKey)).hasValue(42);
        assertThat(typeMap.putReturn(testKey, "42").asAtomicIntegerOpt(testKey)).isNotEmpty();
        assertThat(typeMap.putReturn(testKey, "123456789").asAtomicLong(testKey)).hasValue(123456789L);
        assertThat(typeMap.putReturn(testKey, "123456789").asAtomicLongOpt(testKey)).isNotEmpty();
        assertThat(typeMap.putReturn(testKey, "true").asAtomicBoolean(testKey)).isTrue();
        assertThat(typeMap.putReturn(testKey, "true").asAtomicBooleanOpt(testKey)).isNotEmpty();
        ...
        assertThat(typeMap.putReturn(testKey, UUID.randomUUID().toString()).asUUIDOpt(testKey)).isNotEmpty();
        ...
        assertThat(typeMap.putReturn(testKey, "A").asCharacterOpt(testKey)).contains('A');
        ...
        assertThat(typeMap.putReturn(testKey, "true").asBooleanOpt(testKey)).contains(true);
        ...
        assertThat(typeMap.putReturn(testKey, "false").asBooleanOpt(testKey)).contains(false);
        ...
        assertThat(typeMap.putReturn(testKey, "1").asBooleanOpt(testKey)).contains(true);
        ...
        assertThat(typeMap.putReturn(testKey, "0").asBooleanOpt(testKey)).contains(false);
        ...
        assertThat(typeMap.putReturn(testKey, new IllegalStateException("Test Throwable")).asThrowableOpt(testKey)).isNotEmpty();
        ...
        assertThat(typeMap.putReturn(testKey, "UTF-8").asCharsetOpt(testKey)).contains(UTF_8);
        ...
        assertThat(typeMap.putReturn(testKey, testPath).asFileOpt(testKey)).contains(new File(testPath));
        ...
        assertThat(typeMap.putReturn(testKey, testPath).asPathOpt(testKey)).contains(Paths.get(testPath));
        ...
        assertThat(typeMap.putReturn(testKey, testUr).asURIOpt(testKey)).contains(URI.create(testUr));
        ...
        assertThat(typeMap.putReturn(testKey, testUr).asURLOpt(testKey)).contains(new URL(testUr));
        ...
        assertThat(typeMap.putReturn(testKey, "localhost").asInetAddressOpt(testKey)).contains(InetAddress.getByName("localhost"));
        ...
        assertThat(typeMap.putReturn(testKey, "127.0.0.1").asInet4AddressOpt(testKey)).contains((Inet4Address) Inet4Address.getByName("127.0.0.1"));
        ...
        assertThat(typeMap.putReturn(testKey, "::1").asInet6AddressOpt(testKey)).contains((Inet6Address) Inet6Address.getByName("::1"));
        ...
        assertThat(typeMap.putReturn(testKey, String.valueOf(TEST_TIME)).asDateOpt(testKey)).contains(new Date(TEST_TIME));
        ...
        assertThat(typeMap.putReturn(testKey, String.valueOf(TEST_TIME)).asInstantOpt(testKey)).contains(Instant.ofEpochMilli(TEST_TIME));
        ...
        assertThat(typeMap.putReturn(testKey, calendar).asCalendarOpt(testKey)).isNotEmpty();
        ...
        assertThat(typeMap.putReturn(testKey, TEST_TIME).asLocalDateTimeOpt(testKey)).contains(LocalDateTime.ofInstant(Instant.ofEpochMilli(TEST_TIME), ZoneId.systemDefault()));
        ...
        assertThat(typeMap.putReturn(testKey, TEST_TIME).asLocalDateOpt(testKey)).contains(LocalDate.ofEpochDay(Instant.ofEpochMilli(TEST_TIME).toEpochMilli() / (24 * 60 * 60 * 1000)));
        ...
        assertThat(typeMap.putReturn(testKey, TEST_TIME).asLocalTimeOpt(testKey)).contains(LocalTime.ofNanoOfDay(Instant.ofEpochMilli(TEST_TIME).toEpochMilli() % (24 * 60 * 60 * 1000) * 1000000));
        ...
        assertThat(typeMap.putReturn(testKey, TEST_TIME).asOffsetDateTimeOpt(testKey)).contains(OffsetDateTime.ofInstant(Instant.ofEpochMilli(TEST_TIME), ZoneId.systemDefault()));
        ...
        assertThat(typeMap.putReturn(testKey, TEST_TIME).asZonedDateTimeOpt(testKey)).contains(ZonedDateTime.ofInstant(Instant.ofEpochMilli(TEST_TIME), ZoneId.systemDefault()));
        ...
        assertThat(typeMap.putReturn(testKey, TEST_TIME).asSqlDateOpt(testKey)).contains(new java.sql.Date(TEST_TIME));
        ...
        assertThat(typeMap.putReturn(testKey, TEST_TIME).asTimeOpt(testKey)).contains(new Time(TEST_TIME));
        ...
        assertThat(typeMap.putReturn(testKey, TEST_TIME).asTimestampOpt(testKey)).contains(new Timestamp(TEST_TIME));
    }
